...
@Component({
    selector: 'app-reduce-item-m',
    templateUrl: './reduce-item-m.component.html',
    styleUrls: ['./reduce-item-m.component.css'],

})
export class ReduceItemMComponent implements OnInit {
    @Input()
    modal_name;
    @Input()
    modal_info;
    ...
    submitModal() {
        ...
        if (this.deduction.valid) {
            ...
            this.submit_data = this.deduction.value;
